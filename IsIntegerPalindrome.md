...
Given an integer `number`, return true if `number` is a palindrome, and false otherwise. An integer is a palindrome when it reads the same backward as forward.
